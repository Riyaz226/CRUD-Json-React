...
<canvas id="sparks"></canvas>
    ...
    <div class="container"> 
       <div class="date">
          <span class="dib">On</span>
          <span class="dib">Auguest</span>
          <span class="dib">,6th</span>
       </div>
      
       
       <div class="second">
          <div class="we">WE ALL WAKE UP IN THE NEW WORLD</div>
       </div>
 
 
 <div class="third">
   <div class="we2">Moscow started a full-scale war against Ukraine. No one believed we would hold up for more than 72 hours".<br/>Top To Move Forward.</div>
</div>
    </div> 
